...
def linear():
    ...
    return render_template('linear.html', image=image, k=k, b=b, error=error)
...
def ellipse():
    ...
    return render_template('ellipse.html', image=image, a=a_val, b=b_val, error=error)
...
def plot_3d():
    ...
    error = None
    x_range_display = '-5,5,0.5'
    y_range_display = '-5,5,0.5'
    ...
    if request.method == 'POST':
        try:
            ...
            x_range_display = ','.join(x_range)
            y_range_display = ','.join(y_range)
    ...
    return render_template('3d_plot.html',
                           x_range=x_range_display,
                           y_range=y_range_display,
                           image=image,
                           func_str=func_str,
                           error=error)
...
def parametric():
    ...
    return render_template('parametric.html', image=image, a=a, b=b, c=c,
                           x_func=x_func, y_func=y_func, z_func=z_func, error=error)
